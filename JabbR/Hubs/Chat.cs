    ...
    public class Chat : Hub, IDisconnect, INotificationService
    {
        ...
        public object GetCommands()
        {
            return new[] {
                ...
                new { Name = "flag", Description = "Type /flag [Iso 3366-2 Code] - To show a small flag which represents your nationality. Eg. /flag US for a USA flag. ISO Reference Chart: http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2 (Appologies to people with dual citizenship). "}
            };
        }
