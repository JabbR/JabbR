(function ($, window, ui) {
    ...
    window.captureDocumentWrite = function (documentWritePath, headerText, elementToAppendTo) {
        $.fn.captureDocumentWrite(documentWritePath, function (content) {
            ...
            collapsible = $('<div><h3 class="collapsible_title">' + String.formatLanguageResource('Content_HeaderAndToggle', headerText) + '</h3><div class="collapsible_box captureDocumentWrite_content"></div></div>');
