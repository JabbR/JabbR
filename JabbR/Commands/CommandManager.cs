...
namespace JabbR.Commands
{
    public class CommandManager
    {
        ...
        public void MatchCommand(string commandName, out ICommand command)
        {
            ...
            var exactMatches = _commandCache.Keys.Where(comm => comm.Equals(commandName, StringComparison.CurrentCultureIgnoreCase))
                                                 .ToList();
            ...
            {
                candidates = _commandCache.Keys.Where(comm => comm.StartsWith(commandName, StringComparison.CurrentCultureIgnoreCase))
                                               .ToList();
            }
